...
DROP FUNCTION IF EXISTS `moocdb`.get_real_watching_time_per_video;
...
CREATE FUNCTION get_real_watching_time_per_video (VIDEO_ID VARCHAR(63))
    RETURNS FLOAT
    NOT DETERMINISTIC
BEGIN
...
SELECT 802,
	video_axis.video_id,
	get_real_watching_time_per_video(video_axis.video_id),
    CURRENT_TIMESTAMP
