DROP FUNCTION IF EXISTS `moocdb`.get_watching_frequency_casual_per_video;

CREATE FUNCTION get_watching_frequency_casual_per_video (VIDEO_ID VARCHAR(63))
    RETURNS FLOAT
    NOT DETERMINISTIC
BEGIN
...
SELECT 752,
	video_axis.video_id,
	get_watching_frequency_casual_per_video(video_axis.video_id),
    CURRENT_TIMESTAMP
