DROP FUNCTION IF EXISTS `moocdb`.get_watching_frequency_casual_per_user_per_week;

CREATE FUNCTION get_watching_frequency_casual_per_user_per_week (USER_ID VARCHAR(63), FEATURE_WEEK INT(2), USER_START_TIME TIMESTAMP)
    RETURNS FLOAT
    NOT DETERMINISTIC
BEGIN
...
SELECT 751,
	...
	get_watching_frequency_casual_per_user_per_week(user_long_feature_base.user_id, user_long_feature_base.feature_week, (
